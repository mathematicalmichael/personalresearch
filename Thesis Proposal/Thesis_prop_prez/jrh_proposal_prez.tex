...
\begin{itemize}
	...
	\item The deregularization term will ensure a solution that updates the initial distribution on $\Lambda$ only in the directions in which the data is informative. 
