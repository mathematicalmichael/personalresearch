...
and plasma microturbulence.

	\item Complex particle motion may be described by the solution of an axisymmetric version of the Vlasov-Boltzman equation \footnotemark[1].
Simulating the microturbulence in the plasma involves expensive kinetic simulations, especially when simulating the plasma edge \footnotemark[2]. 

	\begin{itemize}
	
 

		\item An alternate approach is fitting an anomalous diffusion model to  experimental or high-fidelity simulation data.  Deterministic efforts in this setting include \footnotemark[3].  We propose to investigate the data-consistent calibration of an anomalous diffusion model in an axisymmetric setting (XGCa) to high-fidelity experimental or simulation data (XGC1) \footnotemark[2].
...
\footnotetext[2]{S. Ku and R. Hager and C.S. Chang and J.M. Kwon and S.E. Parker}
\footnotetext[3]{Battaglia et al}
